...
(() => {
  ...
  var data = {
    do: {
      ...
      headingDesc: "A comprehensive solution for safeguarding the directors, officers and employees of your business against personal liabilities. Visit our directors and officers page to learn more.",
      "learn-more": "https://plumhq.com/directos-and-officers",
      question: "Who do we recommend directors and officers insurance for?",
      answer: "For technology, healthcare and manufacturing companies, directors and officers cover is crucial. Having said that, a D&O cover can safeguard every business, regardless of industry.",
      whatsCovered: [
        {
          one: "Personal liability of the Directors & Officers",
          two: "Losses incurred by the insured\u2019s company",
          three: "Claims related to buying/selling/ownership of securities. (Only for listed companies)",
    ...
    cgl: {
      ...
      headingDesc: "A commercial general liability policy helps protect a business against financial risks due to death, bodily injury or damage to property suffered by employees/ members of the  public/ other businesses.",
      question: "Who do we recommend the commercial general liability cover for?",
      answer: "For companies in the technology, healthcare and professional services industries, Commercial General Liability (CGL) cover is recommended.",
      whatsCovered: [
        {
      ...
      whatsCovered: [
        {
          ...
          three: "Expenses incurred to determine data restoration and privacy notifications to impacted individuals",
    ...
    eo: {
      ...
      headingDesc: "A professional indemnity policy helps protect a business against financial risks arising out of a negligent act, error/ omission, unintentional breach of contract, or failure to render professional services to a party.",
      question: "Who do we recommend the errors and omission cover for?",
      answer: "It is particularly relevant for industries like consulting and advisory, technology and software development and healthcare. However, any business that provides professional services to clients could benefit from E&O insurance.",
      whatsCovered: [
        {
          ...
          three: "Negligence regarding the content of any media communication/ misappropriation of trade secret",
    ...
    cd: {
      ...
      headingDesc: "A crime and employee dishonesty policy protects a business against financial impairments stemming from any criminal acts committed by an employee/employees like money or securities.",
      question: "Who do we recommend the employee dishonesty cover for?",
      answer: "We recommend employee dishonesty for any industry where employees have access to valuable assets or financial information.",
      whatsCovered: [
        {
          one: "Legal fees",
    ...
    ai: {
      ...
      headingDesc: "An asset protection cover safeguards businesses from losses revolving around damage to physical assets.",
      question: "Who do we recommend the employee dishonesty cover for?",
      answer: "We recommend an asset protection cover for organizations investing in office equipment for their employees/businesses.",
      whatsCovered: [
        {
  ...
  $("[data-element='learn']").on("click", function() {
    $(".background-color-plum-vision-dark").css("overflow", "hidden");
    ...
    $("[data-modal='whatsCovered'] [data-modal-list='one']")[0].innerHTML = product.whatsCovered[0].one;
    $("[data-modal='whatsCovered'] [data-modal-list='two']")[0].innerHTML = product.whatsCovered[0].two;
    $("[data-modal='whatsCovered'] [data-modal-list='three']")[0].innerHTML = product.whatsCovered[0].three;
    $("[data-modal='whatsCovered'] [data-modal-list='four']")[0].innerHTML = product.whatsCovered[0].four;
  ...
  $("[data-element='close']").on("click", function() {
    $(".background-color-plum-vision-dark").css("overflow", "visible");
